...
* implementar painel didático, AVL Tree engine, docker-compose, refatorar D3 renderers lineares e atualizar markdown parser para react-markdown ([62030f0](https://github.com/eduardo-gms/pivot/commit/62030f0fd6d967226fd46972127073e16b59c949))
...
* add security headers to nginx static file serving ([ccd6673](https://github.com/eduardo-gms/pivot/commit/ccd6673dc5e375595c0cc79e402438877c0c52d2))
* adiciona $request_uri ao proxy_pass com variável ([151bb8b](https://github.com/eduardo-gms/pivot/commit/151bb8ba4dc11e82593a70c7b7199a5055b451a6))
...
* configura Nginx para proxy HTTPS upstream correto ([d113659](https://github.com/eduardo-gms/pivot/commit/d113659f9d77c17a2b92ed50625c3a02396059c5))
* correct CI build failures ([1ccadf3](https://github.com/eduardo-gms/pivot/commit/1ccadf35f52f37857593983a52608e961bb19177))
* correct TS error in avlTree due to optional value type in TreeOperation ([3bcc27d](https://github.com/eduardo-gms/pivot/commit/3bcc27d72115b9a7a540b2d9917591e2ef6d74b5))
...
* **deploy:** resolve Azure deploy, Neon migrations and Nginx config blockers ([45ecb07](https://github.com/eduardo-gms/pivot/commit/45ecb07357274e1f5a66fec62abcf6cd2d0be020))
...
* **nginx:** remove Host header overwrite to allow Azure internal routing ([1c5b2a6](https://github.com/eduardo-gms/pivot/commit/1c5b2a627b7144243e6925651de5e5085af4ab48))
